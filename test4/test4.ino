...
//signed int sLUT[2][2] = {0,1,0,-1}; //'set count sign: -1=0,0=1,1=2
//signed char sLUT[2][2] = {-1,0,1,0}; //'set count sign: -1=0,0=1,1=2
//signed int sLUT[2][2] = {-1,0,1,0}; //'set count sign: -1=0,0=1,1=2
int sLUT[2][2];// = {0,-1,0,1}; //'set count sign: -1=0,0=1,1=2
